public class MaquinaExpendedoraSimple {
    ...
    public MaquinaExpendedoraSimple( int coste,String destino) {
        precioBillete = coste;
        balanceClienteActual = 0;
        totalDineroAcumulado = 0;
        estacionOrigen = "Leon";
    ...
    public void nuevoPrecioBillete( int nuevoPrecio)
    {
       precioBillete = nuevoPrecio;
    }
    
    public void reducirValorBillete(int valorAQuitar)
    {
        precioBillete = precioBillete - valorAQuitar;
    }
}
